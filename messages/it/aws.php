...
return [
	...
	'Domain {0} deleted from the list of identities' => 'Il dominio {0} è stato cancellato dalla lista delle Identità',
	'Domain Identity {0} added correctly' => 'Identità del dominio {0} aggiunta correttamente',
	'Email {0} deleted from the list of identities' => 'L\'email {0} è stata cancellata dalla lista delle Identità',
	'Email Template deleted correctly' => 'Email Template cancellato corettamente',
	'SNS Topic {0} added correctly' => 'SNS Topic {0} aggiunto correttamente',
	'SNS Topic {0} deleted correctly' => 'SNS Topic {0} cancellato correttamente',
	'SNS Topic Attribute setted correctly' => 'SNS Topic Attribue settato correttamente',
